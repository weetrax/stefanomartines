...
const Hero: React.FC<HeroProps> = () => {
  ...
  const { text } = useTypewriter({
    words: ["ReactJS", "NodeJS", "C# / .NET", "HTML / CSS"],
    loop: 0,
    typeSpeed: 90,
    deleteSpeed: 60,
    delaySpeed: 1200,
  ...
  return <>
    <Parallax />
    <Container>
      <div className="min-h-screen-nav flex items-center relative z-10">
        <div className="md:w-1/2 lg:w-3/4 -mt-4 text-center md:text-left">
          <h1 className="hero-title text-gradient">
            Hello, moi {`c'est`} Stefano Martines.
            <br />
            Je suis développeur web
            <span className="badge">FullStack</span>
            sur des technos comme
            <span className="badge">{text}<CursorBlink /></span>
          </h1>
        </div>
      </div>
    </Container>
